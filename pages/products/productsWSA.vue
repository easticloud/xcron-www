...
export default {
    ...
    data() {
        return {
            ...
            pmSceneUseS: {
                title: "全站加速",
                imgSrc: "/images/products/productsWSA/s1.svg",
                titletag:
