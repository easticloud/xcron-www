...
export default {
    ...
    data() {
        return {
            ...
            pmPInfoImg: "/images/products/productsBMS/bg.png",
            // 应用场景 
            pmScene: {
                products: 0,
                til: "应用场景",
                ...
                list: [
                    {
                        ...
                        children: {
                            ...
                            src: "/images/products/productsBMS/01.svg",
                            tag: [
                                {
                                    tagTil: "· 集群部署",
                    ...
                    },
                    {
                        ...
                        children: {
                            ...
                            src: "/images/products/productsBMS/02.svg",
                            tag: [
                                {
                                    tagTil: "· 低时延",
                    ...
                    },
                    {
                        ...
                        children: {
                            ...
                            src: "/images/products/productsBMS/03.svg",
                            tag: [
                                {
                                    tagTil: "· 大数据专用实例",
